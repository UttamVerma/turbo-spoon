...
export type MetaObjectForBlogQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type MetaObjectForBlogQuery = {
  metaobjects: {
    edges: Array<{
      node: Pick<StorefrontAPI.Metaobject, 'id' | 'type' | 'handle'> & {
        ...
        person_image?: StorefrontAPI.Maybe<{
          reference?: StorefrontAPI.Maybe<{
            previewImage?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.Image, 'url'>
            >;
        ...
        person_name?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        posted_date?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
      };
    }>;
...
> & {
  images: {edges: Array<{node: Pick<StorefrontAPI.Image, 'id' | 'url'>}>};
  ...
  products: {
    edges: Array<{
      ...
      > & {
        images: {
          edges: Array<{
            node: Pick<StorefrontAPI.Image, 'id' | 'src' | 'altText'>;
          }>;
        };
        variants: {
          edges: Array<{
          ...
          edges: Array<{
            node: Pick<StorefrontAPI.ProductVariant, 'title'> & {
              ...
              compareAtPriceV2?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.MoneyV2, 'amount' | 'currencyCode'>
              >;
              currencySymbol?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query MetaObjectForBlog{\n    metaobjects(type: "custom_blogs", first: 100) {\n      edges {\n        node {\n          id\n          type\n          handle\n          title: field(key: "Title") {\n            value\n          }\n          category: field(key: "Category") {\n            value\n          }\n          description: field(key: "Description") {\n            value\n          }\n          image: field(key: "Image") {\n            reference {\n              ... on MediaImage {\n                previewImage {\n                  url\n                }\n              }\n            }\n          }\n          person_image: field(key: "Person_Image") {\n            reference {\n              ... on MediaImage {\n                previewImage {\n                  url\n                }\n              }\n            }\n          }\n          person_name: field(key: "Person_Name") {\n            value\n          }\n          posted_date: field(key: "Posted_Date") {\n            value\n          }\n        }\n      }\n  }\n}\n': {
    return: MetaObjectForBlogQuery;
    variables: MetaObjectForBlogQueryVariables;
  };
